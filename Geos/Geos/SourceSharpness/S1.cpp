...
void S1::CreateS1( __in int fourierReduciton, __in bool skin, __in const Image & pGrayImage, __out Image* pS1Image )
{
...
void S1::CountFirstRow( LargeBlock* rowToCount, const Image & gray, MagnitudeSpectrum *pMagnitude )
{
...
void S1::CountRow( double **pp256PixelMaP, double **pp64PixelMaP, LargeBlock* rowToCount, LargeBlock *rowAbove, const Image & gray, int rowNumber, MagnitudeSpectrum *pMagnitude )
{
