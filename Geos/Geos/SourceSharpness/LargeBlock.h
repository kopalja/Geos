...
public:
	...
	void CountFirst( const Image & gray, MagnitudeSpectrum *pMagnitude, double** ppPixelValue ); // only first block
	void CountFirstInColumn( double **pixelValue, const Image & gray, MagnitudeSpectrum *pMagnitude ); 
	void CountFirstInRow(  double **pixelValue, LargeBlock *above, const Image & gray, MagnitudeSpectrum *pMagnitude );
	void Count( double** pixelValue, LargeBlock *above, LargeBlock *left, const Image & gray, MagnitudeSpectrum *pMagnitude );
