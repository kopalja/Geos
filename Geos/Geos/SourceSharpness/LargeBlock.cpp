...
void LargeBlock::CountFirst( const Image & gray, MagnitudeSpectrum *pMagnitude, double** ppPixelValue )
{
	baseIndex = 0;
...
void LargeBlock::CountFirstInColumn( double **pixelValue, const Image & gray, MagnitudeSpectrum *pMagnitude )
{
	for (int y = 0; y < 32; y++)
	{
		//shift data left
...
void LargeBlock::CountFirstInRow( double **pixelValue, LargeBlock *above, const Image & gray, MagnitudeSpectrum *pMagnitude )
{
...
void LargeBlock::Count( double** pixelValue, LargeBlock *above, LargeBlock *left, const Image & gray, MagnitudeSpectrum *pMagnitude )
{
